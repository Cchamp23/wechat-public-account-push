...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx665abad705b01471',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'dbba2c32d90cc94871fa94c292127642',
  ...
  USERS: [
    {
      ...
      id: 'oYVsI6BhOKJr7h4URQ-zfvzJggYo',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'GKXVnHV_ZAsxHudAxxDnvJLme05ZHeqKeRzIGLikXSI',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '肇庆',
